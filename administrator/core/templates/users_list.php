...
<tr>
	<td style="text-align: center;">
		...
		<tr style="background-color: #DDDDDD;">
			<td><?php print $i+1; ?></td>
			<td><?php print $THIS_PAGE_DATA["list"]["login"][$i]; ?></td>
			<td><?php print $THIS_PAGE_DATA["list"]["name"][$i]; ?></td>
			<td><?php print $THIS_PAGE_DATA["list"]["status"][$i]; ?></td>
...
<tr>
	<td style="padding-top: 50px; padding-right: 5px; text-align: right;"><a class="a_add" href="/administrator/?page=<?php print $THIS_PAGE; ?>&amp;action=edit">Добавить пользователя</a></td>
</tr>
</table>